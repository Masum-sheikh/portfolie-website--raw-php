...
$select_about="SELECT * FROM mabouts WHERE id=1";
...
$select_about_expertise=mysqli_query($db_connect, $select_expertise);
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-12 col-md-7">
				<div class="ml-5 position-relative mt-5 mt-lg-0">
					...
					<h1 class="font-weight-normal text-color text-md"><i class="ti-minus mr-2"></i> <?= $after_assoc_about['name']?></h1>
					<h2 class="mt-3 text-lg mb-3 text-capitalize"><?= $after_assoc_about['designaton']?></h2>
...
<section class="section bg-gray" id="skillbar" data-aos="fade-up">
	<div class="container">
		...
		<div class="row">
			<?php foreach($select_about_expertise as $skill) {?>
			<div class="col-lg-6 col-md-6">
				<div class="skill-bar mb-4 mb-lg-0">
					<div class="mb-4 text-right"><h4 class="font-weight-normal"><?= $skill['topic_name'] ?></h4></div>
					<div class="progress">
						<div class="progress-bar" data-percent="<?= $skill['persentage'] ?>">
							<span class="percent-text"><span class="count"><?= $skill['persentage'] ?></span>%</span>
						</div>
					</div>
				</div>
			</div>
